...
# The Comment Table is now declared safely BEFORE db.create_all() runs
...
# FIX: Added methods=["GET", "POST"] right here!
...
if __name__ == "__main__":
    # Get port from environment variable, default to 5000 if not found locally
